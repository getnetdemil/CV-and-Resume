...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Research focus: Hydrology modeling using AI and remote sensing}
        \item {Deep learning for snow water characteristics estimation from satellite imagery}
      \end{cvitems}
    }
...
%---------------------------------------------------------
\begin{cvparagraph}
Not yet applicable at current career stage (PhD candidate, Research Career Stage I).
\end{cvparagraph}
...
%---------------------------------------------------------
\begin{cvparagraph}
Not yet applicable at current career stage.
\end{cvparagraph}
