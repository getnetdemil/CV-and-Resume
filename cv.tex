...
%
% Structure follows TENK 2020 Researcher's Curriculum Vitae Template
% (Finnish National Board on Research Integrity, sections 1–15)
%
%-------------------------------------------------------------------------------
% CONFIGURATIONS
%-------------------------------------------------------------------------------
...
\begin{cventries}
  ...
  \cventry
    ...
    {Ethiopia} % Location
    {2018 -- 2020} % Date(s) — TODO: verify exact start and end dates
    {
      \begin{cvitems}
        \item {Full-time position in electrical power systems engineering}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Ethiopia} % Location
    {2016 -- 2018} % Date(s) — TODO: verify exact start and end dates
    {
      \begin{cvitems}
...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Full scholarship covering tuition, travel, and living expenses for the EMJMD in Image Processing and Computer Vision across three European universities}
      \end{cvitems}
    }
\end{cventries}
